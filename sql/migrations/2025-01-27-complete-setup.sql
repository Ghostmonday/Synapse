...
BEGIN
    ...
    RETURN 'sinapse-api-keys-master-key-CHANGE-THIS-IN-PRODUCTION-2025-R7KX4HNBFY';
END;
...
SELECT store_api_key('LIVEKIT_URL', 'livekit', 
    'wss://sinapse-ysfq2dir.livekit.cloud',
    'LiveKit WebSocket URL', 
    'production'
);

SELECT store_api_key('LIVEKIT_HOST', 'livekit', 
    'sinapse-ysfq2dir.livekit.cloud',
    'LiveKit Host', 
    'production'
);
...
SELECT store_api_key('AWS_S3_BUCKET', 'aws', 
    'sinapse-files',  -- ⚠️ UPDATE IF YOU HAVE S3 BUCKET
    'AWS S3 Bucket Name', 
    'production'
);
