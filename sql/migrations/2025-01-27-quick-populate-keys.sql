...
SELECT store_api_key('APPLE_SERVICE_ID', 'apple', 'com.ghostmonday.sinapse', 'Apple Service ID', 'production');
SELECT store_api_key('APPLE_CLIENT_ID', 'apple', 'com.ghostmonday.sinapse', 'Apple Client ID', 'production');
...
SELECT store_api_key('LIVEKIT_URL', 'livekit', 'wss://sinapse-ysfq2dir.livekit.cloud', 'LiveKit URL', 'production');
SELECT store_api_key('LIVEKIT_HOST', 'livekit', 'sinapse-ysfq2dir.livekit.cloud', 'LiveKit Host', 'production');
