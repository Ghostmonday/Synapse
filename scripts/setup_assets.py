...
Run this from the Synapse directory: python3 scripts/setup_assets.py
"""
...
# Paths
SOURCE_DIR = Path("/Users/rentamac/Desktop/pixxx")
ASSETS_BASE = Path("/Users/rentamac/Desktop/Synapse/frontend/iOS/Assets.xcassets/Images")
...
def main():
    ...
    print("\nNext steps:")
    print("1. Open Xcode")
    print("2. Right-click Assets.xcassets → Add Files to 'Sinapse'...")
