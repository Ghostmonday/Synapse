        ...
        VStack(spacing: 16) {
            ...
            ZStack {
                RoundedRectangle(cornerRadius: 12)
                    .fill(isOver ? Color("SinapseGold").opacity(0.1) : Color(.secondarySystemBackground))
                    .overlay(
                        RoundedRectangle(cornerRadius: 12)
                            .stroke(
                                isOver ? Color("SinapseGold") : Color.gray.opacity(0.3),
                ...
                VStack(spacing: 12) {
                    Image(systemName: isOver ? "arrow.down.circle.fill" : "square.and.arrow.up")
                        .font(.system(size: 48))
                        .foregroundColor(isOver ? Color("SinapseGold") : .secondary)
