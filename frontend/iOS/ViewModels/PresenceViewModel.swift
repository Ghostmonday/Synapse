...
class PresenceViewModel: ObservableObject {
    ...
    private func loadPresence() async {
        do {
            ...
            Logger(subsystem: "com.sinapse.app", category: "PresenceViewModel").error("[PresenceViewModel] Error loading presence: \(error.localizedDescription)")
    ...
    private func fetchUserPresenceStatus(userId: UUID) async -> PresenceStatus? {
        ...
        do {
            ...
            Logger(subsystem: "com.sinapse.app", category: "PresenceViewModel").error("[PresenceViewModel] Error fetching presence for user \(userId): \(error.localizedDescription)")
    ...
    func joinRoom(_ room: Room) async {
        ...
        do {
            ...
            Logger(subsystem: "com.sinapse.app", category: "PresenceViewModel").error("Presence update error: \(error.localizedDescription)")
        }
